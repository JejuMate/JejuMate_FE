...
export default function Home() {
  ...
  const popularSpots: PopularSpot[] = [
    ...
    },
    {
      ...
      favoriteCount: 650,
      totalScore: 1500,
      image: 'https://readdy.ai/api/search-image?query=Delicious%20Jeju%20black%20pork%20barbecue%20grilled%20meat%20Korean%20cuisine%2C%20traditional%20restaurant%20setting%2C%20appetizing%20food%20photography%2C%20warm%20lighting%2C%20local%20specialty&width=300&height=200&seq=3&orientation=landscape',
    ...
    },
    {
      ...
      favoriteCount: 560,
      totalScore: 1340,
      image: 'https://readdy.ai/api/search-image?query=Scenic%20Udo%20island%20near%20Jeju%20with%20pristine%20turquoise%20beaches%2C%20coastal%20cliffs%2C%20peaceful%20island%20atmosphere%2C%20clear%20blue%20water%2C%20natural%20beauty&width=300&height=200&seq=4&orientation=landscape',
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">인기 여행지 순위</h3>
              <p className="text-gray-600">많은 여행자들이 선택한 제주도 명소들</p>
            </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h3 className="text-3xl font-bold mb-4">나만의 제주 여행을 계획해보세요</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white mb-8">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold mb-4">새로운 제주 여행을 계획해보세요</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-semibold text-gray-900">최근 추천 기록</h3>
                <Link href="/history" className="text-blue-600 hover:text-blue-700 text-sm font-medium cursor-pointer">
                  전체보기
                </Link>
              </div>
              ...
              {recentRecommendations.length > 0 ? (
                <div className="space-y-4">
                  {recentRecommendations.map((rec) => (
                    <div key={rec.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 cursor-pointer">
          ...
          <div className="space-y-6">
            {/* 저장된 일정 */}
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">저장된 일정</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                {popularSpots.slice(0, 3).map((spot) => (
                  <div key={spot.id} className="flex items-center space-x-3 cursor-pointer hover:bg-gray-50 p-2 rounded-lg">
                    <img 
                      src={spot.image} 
                      alt={spot.name}
