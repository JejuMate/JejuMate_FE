            ...
            items: [
                {
                    ...
                    duration: "2시간",
                    cost: "5,000원",
                    latitude: 33.45887781818221,
                    longitude: 126.94203285953628,
                },
                {
                    id: "1-2",
                    time: "12:00",
                    ...
                    duration: "1시간",
                    cost: "25,000원",
                    latitude: 33.470069658818936,
                    longitude: 126.9301109825157,
                },
                {
                    id: "1-3",
                    time: "15:00",
            ...
            items: [
                {
                    ...
                    duration: "4시간",
                    cost: "무료",
                    latitude: 33.37664980606544,
                    longitude: 126.54234890861808,
                },
                {
                    id: "2-2",
                    time: "16:00",
                    ...
                    duration: "1.5시간",
                    cost: "35,000원",
                    latitude: 33.471591268768016,
                    longitude: 126.55293121544113,
                },
                {
                    id: "2-3",
                    time: "19:00",
                    ...
                    duration: "2시간",
                    cost: "20,000원",
                    latitude: 33.51161237251523,
                    longitude: 126.52606567072522,
                },
            ],
        },
    ];
    ...
    return (
        <>
            <Script
                ...
                onError={() => console.error("네이버 지도 로드 실패")}
            />
    ...
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver((entries) => {
            for (let entry of entries) {
                ...
                setMapHeight(Math.max(400, newHeight));
            }
        });
        ...
        <RequireAuth>
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="bg-gradient-to-r from-gray-800 to-gray-700 p-4">
                    <h2 className="text-xl font-bold text-white">Day {daySchedule.day}</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <span className="bg-blue-100 text-blue-800 px-2 py-1 rounded-full text-xs">
                        ...
                        <div className="lg:sticky lg:top-4">
                            {isMapLoaded ? (
                                <Map daySchedule={daySchedule} height={`${mapHeight}px`}/>
                            ) : (
                                <div
