...
export const TRAVEL_CATEGORIES = [
  { id: 'hiking', label: '등산 및 오름', icon: 'ri-mountain-line', color: 'bg-green-50 text-green-600 border-green-200' },
  { id: 'activity', label: '액티비티', icon: 'ri-run-line', color: 'bg-orange-50 text-orange-600 border-orange-200' },
  { id: 'culture', label: '문화 & 역사', icon: 'ri-building-line', color: 'bg-purple-50 text-purple-600 border-purple-200' },
  { id: 'theme-park', label: '테마파크', icon: 'ri-flashlight-line', color: 'bg-pink-50 text-pink-600 border-pink-200' },
  { id: 'beach', label: '해수욕장', icon: 'ri-sun-line', color: 'bg-blue-50 text-blue-600 border-blue-200' },
  { id: 'drive', label: '산책 및 드라이브', icon: 'ri-car-line', color: 'bg-indigo-50 text-indigo-600 border-indigo-200' },
  { id: 'experience', label: '체험 및 실내 관광', icon: 'ri-home-smile-line', color: 'bg-yellow-50 text-yellow-600 border-yellow-200' }
] as const;
